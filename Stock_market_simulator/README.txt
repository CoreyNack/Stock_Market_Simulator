...
Running:
This experiment runs best in PsychoPy version 2021.2.3. Running it in other versions, especially on Mac, may cause difficulties. After installing PsychoPy, find and open the Stock_Market_Simulator.psyexp 
file in the folder. 
...
Citation:
A preprint for this project is pending. If you wish to use this program, please cite the preprint wen available. 
